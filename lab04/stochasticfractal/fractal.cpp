    ...
    , ui(new Ui::Fractal)
{
    ...
    int n = qCeil(std::log2(qMax(width_, height_) - 1));
    dots_ = qPow(2, n) + 1;
...
void Fractal::fillPlazma (int& x1, int& y1, int& x2, int& y2) {
...
void Fractal::paintEvent (QPaintEvent *qp) {
    Q_UNUSED (qp);
